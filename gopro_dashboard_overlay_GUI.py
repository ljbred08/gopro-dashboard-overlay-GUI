...
section1_options = [
    ...
    {'label': 'Config Dir', 'key': 'config_dir', 'tooltip': f'Location of config files (api keys, profiles, ...) (default: {os.path.expanduser("~")}\.gopro-graphics)', 'default_value': ''},
    {'label': 'Cache Dir', 'key': 'cache_dir', 'tooltip': f'Location of caches (map tiles, ...) (default: {os.path.expanduser("~")}\.gopro-graphics)', 'default_value': ''},
